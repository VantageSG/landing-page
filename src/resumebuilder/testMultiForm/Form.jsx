...
import { Form, Segment, Button, Container, Card, Modal, Header, Image } from "semantic-ui-react";
  ...
  return (
    <div className="ui two buttons">
      ...
      {props.step === props.maxStep ? (
        <ModalConfirm props={props} color="green" onClick={props.submitAndContinue} content="Confirm and Submit"></ModalConfirm>
      ) : (
...
const ModalConfirm = props => {
  console.log(props)
  return (<Modal trigger={<Button color="green" onClick={props.submitAndContinue} content="Confirm and Submit"></Button>}centered={false}>
...
export default class FormStep extends Component {
  ...
  render() {
    ...
    const {education, program, institution, startEdu, endEdu, grade} = this.state;
    const educationValues= {education, program, institution, startEdu, endEdu, grade}

    const {workExperience, title, company, start, end, achievements} = this.state;
    const workExperienceValues = {workExperience, title, company, start, end, achievements};
